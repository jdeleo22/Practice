...
public class IceCreamShop {
  ...
  public static void main(String[] args) {
    ...
    ShopItems.NonVegan nonVegan = si.new NonVegan();
    ShopItems.Vegan vegan = si.new Vegan();
    ...
    System.out.println("Thank you for your order! Today we have sold " + si.totalCount + " orders of sweetness!");
